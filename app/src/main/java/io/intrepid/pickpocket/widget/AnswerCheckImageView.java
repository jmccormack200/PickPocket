...
public class AnswerCheckImageView extends ImageView {
    ...
    public void setImageWrong(){
        setBackground(getContext().getDrawable(colorWhite ? R.drawable.ic_check_box_outline_blank_white_24px :R.drawable.ic_check_box_outline_blank_black_24px));
    }

    public void setImageCorrectValueWrongLocation(){
        setBackground(getContext().getDrawable(colorWhite ? R.drawable.ic_indeterminate_check_box_white_24px : R.drawable.ic_indeterminate_check_box_black_24px));
    }

    public void setImageCorrect(){
        setBackground(getContext().getDrawable(colorWhite ? R.drawable.ic_check_box_white_24px : R.drawable.ic_check_box_black_24px));
    }
}
