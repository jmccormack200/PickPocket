...
public class ViewAnimator {
    ...
    public void showMenuContent(List<CodeBreakerGuess> list) {
        viewList.clear();
        ...
        for (int i = 0; i < size; i++) {
            ...
            ((TextView) viewMenu.findViewById(R.id.menu_item_label)).setText(TextUtils.join("",
                                                                                            list.get(i).getGuess()));
            ((AnswerBoxView) viewMenu.findViewById(R.id.answer_check)).setNumberCorrect(list.get(i).getNumberCorrect(),
                                                                                        list.get(i)
                                                                                                .getNumberInAnswer());
    ...
    public interface ViewAnimatorListener {
        ...
        void removeViewsFromContainers();
    }
}